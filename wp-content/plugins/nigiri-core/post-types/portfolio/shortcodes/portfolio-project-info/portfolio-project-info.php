...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'nigiri-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'nigiri-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'nigiri-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'nigiri-core' ),
							'value'       => array(
								esc_html__( 'Title', 'nigiri-core' )          => 'title',
								esc_html__( 'Category', 'nigiri-core' )       => 'category',
								esc_html__( 'Tag', 'nigiri-core' )            => 'tag',
								esc_html__( 'Author', 'nigiri-core' )         => 'author',
								esc_html__( 'Date', 'nigiri-core' )           => 'date',
								esc_html__( 'Featured Image', 'nigiri-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'nigiri-core' ),
							'value'       => array_flip( nigiri_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'nigiri-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'nigiri-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'nigiri-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'nigiri-core' ),
							'value'      => array_flip( nigiri_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
