	...
	<div class="eltdf-pcl-inner eltdf-outer-space clearfix">
		<?php
			if ( ! empty( $query_results ) ) {
				foreach ( $query_results as $query ) {
					...
					<article class="eltdf-pcl-item eltdf-item-space">
						<div class="eltdf-pcl-item-inner">
							<?php echo nigiri_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'parts/image', '', $params ); ?>
							<div class="eltdf-pcli-text-holder">
								<div class="eltdf-pcli-text-wrapper">
									<div class="eltdf-pcli-text">
										<?php echo nigiri_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'parts/title', '', $params ); ?>
										<?php echo nigiri_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'parts/excerpt', '', $params ); ?>
									</div>
								</div>
							</div>
				...
				echo nigiri_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'parts/posts-not-found', '', $params );
			}
		?>
	</div>
</div>