<?php
if ( ! function_exists( 'nigiri_elated_init_google_fonts_array' ) ) {
    function nigiri_elated_init_google_fonts_array() {
        ...
        $nigiri_elated_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'nigiri_elated_init_google_fonts_array');
}