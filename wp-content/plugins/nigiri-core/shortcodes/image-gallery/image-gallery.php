<?php
namespace NigiriCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'nigiri-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'nigiri-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'nigiri-core' ) => 'grid',
								esc_html__( 'Masonry', 'nigiri-core' )    => 'masonry',
								esc_html__( 'Slider', 'nigiri-core' )     => 'slider',
								esc_html__( 'Carousel', 'nigiri-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						...
						array(
							...
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'nigiri-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'nigiri-core' ),
							'value'      => array(
								esc_html__( 'None', 'nigiri-core' )             => '',
								esc_html__( 'Open Lightbox', 'nigiri-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'nigiri-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'nigiri-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'nigiri-core' )        => 'grayscale'
							)
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'custom_links',
							'heading'     => esc_html__( 'Custom Links', 'nigiri-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'nigiri-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'nigiri-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'nigiri-core' ),
							'value'       => array_flip( nigiri_elated_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = nigiri_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
