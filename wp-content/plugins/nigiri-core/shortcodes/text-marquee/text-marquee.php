...
namespace NigiriCore\CPT\Shortcodes\TextMarquee;
...
class TextMarquee implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Text Marquee', 'nigiri-core' ),
					'base'                      => $this->getBase(),
	...
	public function render( $atts, $content = null ) {
		...
		$html = nigiri_core_get_shortcode_module_template_part( 'templates/text-marquee', 'text-marquee', '', $params );
