<?php
namespace NigiriCore\CPT\Shortcodes\SingleImage;
...
class SingleImage implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Single Image', 'nigiri-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'image_horizontal_anilgnment',
							'heading'    => esc_html__( 'Image Horizontal Alignment', 'nigiri-core' ),
							'value'      => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Moving on Hover', 'nigiri-core' )  => 'moving'
							)
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		$args   = array(
			'image'                         => '',
			'image_size'                    => 'full',
			'image_horizontal_anilgnment'   => 'left',
		...
		$html = nigiri_core_get_shortcode_module_template_part( 'templates/single-image', 'single-image', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['image_horizontal_anilgnment'] ) ? 'eltdf-image-' . $params['image_horizontal_anilgnment'] : '';
