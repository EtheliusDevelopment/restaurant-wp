...
class ItemShowcaseItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Item Showcase List Item', 'nigiri-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'heading'     => esc_html__( 'Item Position', 'nigiri-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Item Title', 'nigiri-core' ),
							'admin_label' => true
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Item Target', 'nigiri-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Item Title Tag', 'nigiri-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Title Color', 'nigiri-core' ),
							'dependency' => array( 'element' => 'item_title', 'not_empty' => true )
						),
						array(
							'type'       => 'textarea',
							'param_name' => 'item_text',
							'heading'    => esc_html__( 'Item Text', 'nigiri-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'item_text_color',
							'heading'    => esc_html__( 'Item Text Color', 'nigiri-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = nigiri_core_get_shortcode_module_template_part( 'templates/item-showcase-item', 'item-showcase', '', $params );
