<?php
namespace NigiriCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'nigiri-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'layout',
							'heading'     => esc_html__( 'Layout', 'nigiri-core' ),
							'value'       => array(
								esc_html__( 'Normal', 'nigiri-core' ) => 'normal',
								esc_html__( 'Simple', 'nigiri-core' ) => 'simple'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'nigiri-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'nigiri-core' ),
							'value'      => array(
								esc_html__( '80/20', 'nigiri-core' ) => '80',
								esc_html__( '75/25', 'nigiri-core' ) => '75',
								esc_html__( '66/33', 'nigiri-core' ) => '66',
								esc_html__( '50/50', 'nigiri-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
							...
							'value'       => esc_html__( 'Button Text', 'nigiri-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'button_top_margin',
							'heading'    => esc_html__( 'Button Top Margin (px)', 'nigiri-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'nigiri-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_type',
							'heading'     => esc_html__( 'Button Type', 'nigiri-core' ),
							'value'       => array(
								esc_html__( 'Solid', 'nigiri-core' )   => 'solid',
								esc_html__( 'Outline', 'nigiri-core' ) => 'outline'
							),
							'save_always' => true,
							'group'       => esc_html__( 'Button Style', 'nigiri-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'nigiri-core' ),
							'value'       => array(
								esc_html__( 'Default', 'nigiri-core' ) => '',
								esc_html__( 'Small', 'nigiri-core' )   => 'small',
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link', 'nigiri-core' ),
							'group'      => esc_html__( 'Button Style', 'nigiri-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'button_target',
							'heading'    => esc_html__( 'Button Link Target', 'nigiri-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'nigiri-core' ),
							'group'      => esc_html__( 'Button Style', 'nigiri-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'nigiri-core' ),
							'group'      => esc_html__( 'Button Style', 'nigiri-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_background_color',
							'heading'    => esc_html__( 'Button Background Color', 'nigiri-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'nigiri-core' ),
							'group'      => esc_html__( 'Button Style', 'nigiri-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'nigiri-core' ),
							'group'      => esc_html__( 'Button Style', 'nigiri-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'nigiri-core' ),
							'group'      => esc_html__( 'Button Style', 'nigiri-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'nigiri-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'nigiri-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = nigiri_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . nigiri_elated_filter_px( $params['button_top_margin'] ) . 'px';
		}
