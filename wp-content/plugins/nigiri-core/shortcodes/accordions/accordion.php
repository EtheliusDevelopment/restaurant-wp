<?php
namespace NigiriCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'nigiri-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'nigiri-core' ) => 'accordion',
								esc_html__( 'Toggle', 'nigiri-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Boxed', 'nigiri-core' )  => 'boxed',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'nigiri-core' ),
							'value'      => array(
								esc_html__( 'Default', 'nigiri-core' ) => '',
								esc_html__( 'White', 'nigiri-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = nigiri_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
