<?php
namespace NigiriCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'nigiri-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Background Color', 'nigiri-core' )
						),
						array(
							'type'       => 'attach_image',
							'param_name' => 'background_image',
							'heading'    => esc_html__('Background Image', 'nigiri-core')
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'background_position',
							'heading'     => esc_html__( 'Background Image Position', 'nigiri-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'nigiri-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'nigiri-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'nigiri-core' )   => 'cover',
								esc_html__( 'Contain', 'nigiri-core' ) => 'contain',
								esc_html__( 'Inherit', 'nigiri-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'nigiri-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'nigiri-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'nigiri-core' ),
							'value'       => array(
								esc_html__( 'Default', 'nigiri-core' ) => '',
								esc_html__( 'Top', 'nigiri-core' )     => 'top',
								esc_html__( 'Middle', 'nigiri-core' )  => 'middle',
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'nigiri-core' ),
							'value'       => array(
								esc_html__( 'Default', 'nigiri-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'nigiri-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'nigiri-core' ),
							'value'       => array(
								esc_html__( 'Default', 'nigiri-core' ) => '',
							...
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements and for full screen sections navigation/pagination', 'nigiri-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'nigiri-core'),
							'group'       => esc_html__('Responsiveness', 'nigiri-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'nigiri-core'),
							'group'       => esc_html__('Responsiveness', 'nigiri-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'nigiri-core'),
							'group'       => esc_html__('Responsiveness', 'nigiri-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'nigiri-core'),
							'group'       => esc_html__('Responsiveness', 'nigiri-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = nigiri_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
