...
namespace NigiriCore\CPT\Shortcodes\CustomFont;
...
class CustomFont implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Custom Font', 'nigiri-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
							'heading'    => esc_html__( 'Title Text', 'nigiri-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type_out_effect',
							'heading'     => esc_html__( 'Enable Type Out Effect', 'nigiri-core' ),
							'description' => esc_html__( 'Adds a type out effect inside custom font content', 'nigiri-core' ),
							'value'       => array_flip( nigiri_elated_get_yes_no_select_array( false ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'type_out_position',
							'heading'     => esc_html__( 'Position of Type Out Effect', 'nigiri-core' ),
							'description' => esc_html__( 'Enter the position of the word after which you would like to display type out effect (e.g. if you would like the type out effect after the 3rd word, you would enter "3")', 'nigiri-core' ),
							'dependency'  => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'typed_color',
							'heading'    => esc_html__( 'Typed Color', 'nigiri-core' ),
							'dependency' => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_1',
							'heading'    => esc_html__( 'Typed Ending Number 1', 'nigiri-core' ),
							'dependency' => Array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_2',
							'heading'    => esc_html__( 'Typed Ending Number 2', 'nigiri-core' ),
							'dependency' => array( 'element' => 'typed_ending_1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_3',
							'heading'    => esc_html__( 'Typed Ending Number 3', 'nigiri-core' ),
							'dependency' => array( 'element' => 'typed_ending_2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_4',
							'heading'    => esc_html__( 'Typed Ending Number 4', 'nigiri-core' ),
						...
						array(
							...
							'description' => esc_html__( 'Enter the positions of the words after which you would like to create a line break (e.g. if you would like the line break after the 3rd and 8th words, you would enter "3,8")', 'nigiri-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Font Family', 'nigiri-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_size',
							'heading'    => esc_html__( 'Font Size (px or em)', 'nigiri-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'line_height',
							'heading'    => esc_html__( 'Line Height (px or em)', 'nigiri-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'font_weight',
							'heading'     => esc_html__( 'Font Weight', 'nigiri-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Font Style', 'nigiri-core' ),
							'value'       => array_flip( nigiri_elated_get_font_style_array( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'letter_spacing',
							'heading'    => esc_html__( 'Letter Spacing (px or em)', 'nigiri-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_transform',
							'heading'     => esc_html__( 'Text Transform', 'nigiri-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Text Decoration', 'nigiri-core' ),
							'value'       => array_flip( nigiri_elated_get_text_decorations( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'     => esc_html__( 'Text Align', 'nigiri-core' ),
							'value'       => array(
								...
								esc_html__( 'Justify', 'nigiri-core' ) => 'justify'
							),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'margin',
							'heading'     => esc_html__( 'Margin (px or %)', 'nigiri-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'nigiri-core' ),
							'group'      => esc_html__( 'Laptops', 'nigiri-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'nigiri-core' ),
							'group'      => esc_html__( 'Tablets Landscape', 'nigiri-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'nigiri-core' ),
							'group'      => esc_html__( 'Tablets Portrait', 'nigiri-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'nigiri-core' ),
							'group'      => esc_html__( 'Mobiles', 'nigiri-core' )
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = nigiri_core_get_shortcode_module_template_part( 'templates/custom-font', 'custom-font', '', $params );
	...
	private function getHolderStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			if ( nigiri_elated_string_ends_with( $params['font_size'], 'px' ) || nigiri_elated_string_ends_with( $params['font_size'], 'em' ) ) {
		...
		if ( ! empty( $params['line_height'] ) ) {
			if ( nigiri_elated_string_ends_with( $params['line_height'], 'px' ) || nigiri_elated_string_ends_with( $params['line_height'], 'em' ) ) {
		...
		if ( ! empty( $params['letter_spacing'] ) ) {
			if ( nigiri_elated_string_ends_with( $params['letter_spacing'], 'px' ) || nigiri_elated_string_ends_with( $params['letter_spacing'], 'em' ) ) {
	...
	private function getHolderData( $params ) {
		...
		if ( $params['font_size_1366'] !== '' ) {
			if ( nigiri_elated_string_ends_with( $params['font_size_1366'], 'px' ) || nigiri_elated_string_ends_with( $params['font_size_1366'], 'em' ) ) {
		...
		if ( $params['font_size_1024'] !== '' ) {
			if ( nigiri_elated_string_ends_with( $params['font_size_1024'], 'px' ) || nigiri_elated_string_ends_with( $params['font_size_1024'], 'em' ) ) {
		...
		if ( $params['font_size_768'] !== '' ) {
			if ( nigiri_elated_string_ends_with( $params['font_size_768'], 'px' ) || nigiri_elated_string_ends_with( $params['font_size_768'], 'em' ) ) {
		...
		if ( $params['font_size_680'] !== '' ) {
			if ( nigiri_elated_string_ends_with( $params['font_size_680'], 'px' ) || nigiri_elated_string_ends_with( $params['font_size_680'], 'em' ) ) {
		...
		if ( $params['line_height_1366'] !== '' ) {
			if ( nigiri_elated_string_ends_with( $params['line_height_1366'], 'px' ) || nigiri_elated_string_ends_with( $params['line_height_1366'], 'em' ) ) {
		...
		if ( $params['line_height_1024'] !== '' ) {
			if ( nigiri_elated_string_ends_with( $params['line_height_1024'], 'px' ) || nigiri_elated_string_ends_with( $params['line_height_1024'], 'em' ) ) {
		...
		if ( $params['line_height_768'] !== '' ) {
			if ( nigiri_elated_string_ends_with( $params['line_height_768'], 'px' ) || nigiri_elated_string_ends_with( $params['line_height_768'], 'em' ) ) {
		...
		if ( $params['line_height_680'] !== '' ) {
			if ( nigiri_elated_string_ends_with( $params['line_height_680'], 'px' ) || nigiri_elated_string_ends_with( $params['line_height_680'], 'em' ) ) {
	...
	private function getModifiedTitle( $params ) {
		...
		if ( ! empty( $title ) && ( $type_out_effect === 'yes' || ! empty( $title_break_words ) ) ) {
			...
			if ( $type_out_effect === 'yes' && ! empty( $type_out_position ) ) {
				...
				$typed_html = '<span class="eltdf-cf-typed-wrap" ' . nigiri_elated_get_inline_style( $typed_styles ) . '><span class="eltdf-cf-typed">';
