...
include 'nigiri-instagram-helper.php';

/**
 * Class NigiriInstagramApi
 */
class NigiriInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var NigiriInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var NigiriInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'nigiri_instagram_code';
	const USER_ID_OPTION_NAME = 'nigiri_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'nigiri_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'nigiri_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->helper       = new NigiriInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see NigiriInstagramApi::buildCurrentPageURI()
	 */
	 ...
	 *
	 * @see NigiriInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see NigiriInstagramApi::getAccessToken()
	 */
