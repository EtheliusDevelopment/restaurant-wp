...
/**
 * Class NigiriInstagramHelper
 */
class NigiriInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines nigiri_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'nigiri_instagram_image_atts',
			array(
				'class'  => $imageSize,
