...
if ( ! function_exists( 'nigiri_elated_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function nigiri_elated_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'nigiri_elated_filter_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'nigiri_elated_header_vertical_navigation_options_map' ) ) {
	function nigiri_elated_header_vertical_navigation_options_map() {
		$hide_dep_options = nigiri_elated_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = nigiri_elated_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'nigiri' ),
		...
		$drop_down_group = nigiri_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'nigiri' )
			)
		);
		
		$vertical_drop_down_row1 = nigiri_elated_add_admin_row(
			array(
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'nigiri' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'nigiri' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => 'below',
				'label'         => esc_html__( 'Submenu Opening', 'nigiri' ),
				'options'		=> array(
					'below' => esc_html__('Below', 'nigiri'),
					'side' => esc_html__('On Side', 'nigiri'),
				),
				'parent'        => $panel_vertical_main_menu
			)
		);

		$group_vertical_first_level = nigiri_elated_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'nigiri' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'nigiri' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = nigiri_elated_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = nigiri_elated_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = nigiri_elated_add_admin_row(
			array(
		...
		$group_vertical_second_level = nigiri_elated_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'nigiri' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'nigiri' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = nigiri_elated_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = nigiri_elated_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = nigiri_elated_add_admin_row(
			array(
		...
		$group_vertical_third_level = nigiri_elated_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'nigiri' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'nigiri' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = nigiri_elated_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = nigiri_elated_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = nigiri_elated_add_admin_row(
			array(
	...
	add_action( 'nigiri_elated_action_additional_header_main_navigation_options_map', 'nigiri_elated_header_vertical_navigation_options_map', 10, 1 );
}