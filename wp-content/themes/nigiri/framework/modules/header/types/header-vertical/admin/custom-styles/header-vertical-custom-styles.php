...
if ( ! function_exists( 'nigiri_elated_vertical_menu_styles' ) ) {
	function nigiri_elated_vertical_menu_styles() {
	...
	add_action( 'nigiri_elated_action_style_dynamic', 'nigiri_elated_vertical_menu_styles' );
}

if ( ! function_exists( 'nigiri_elated_vertical_main_menu_styles' ) ) {
	/**
	 * Generates styles for vertical main main menu
	 */
	function nigiri_elated_vertical_main_menu_styles() {
		$menu_holder_styles = array();
		
		$menu_top_margin    = nigiri_elated_options()->getOptionValue( 'vertical_menu_top_margin' );
		$menu_bottom_margin = nigiri_elated_options()->getOptionValue( 'vertical_menu_bottom_margin' );
		
		if ( ! empty( $menu_top_margin ) ) {
			$menu_holder_styles['margin-top'] = nigiri_elated_filter_px( $menu_top_margin ) . 'px';
		}
		if ( ! empty( $menu_bottom_margin ) ) {
			$menu_holder_styles['margin-bottom'] = nigiri_elated_filter_px( $menu_bottom_margin ) . 'px';
		}
		...
		echo nigiri_elated_dynamic_css( $menu_holder_selector, $menu_holder_styles );
	...
	add_action( 'nigiri_elated_action_style_dynamic', 'nigiri_elated_vertical_main_menu_styles' );
}