...
if ( ! function_exists( 'nigiri_elated_get_hide_dep_for_header_main_menu_options' ) ) {
	function nigiri_elated_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'nigiri_elated_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'nigiri_elated_header_main_navigation_options_map' ) ) {
	function nigiri_elated_header_main_navigation_options_map() {
		$hide_dep_options = nigiri_elated_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = nigiri_elated_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'nigiri' ),
		...
		nigiri_elated_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'nigiri' )
			)
		);
		
		$drop_down_group = nigiri_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'nigiri' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'nigiri' )
			)
		);
		
		$drop_down_row1 = nigiri_elated_add_admin_row(
			array(
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'nigiri' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'nigiri' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'nigiri' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'nigiri' )
				)
			)
		);
		...
		$first_level_group = nigiri_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'nigiri' )
			)
		);
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'nigiri' ),
			)
		);
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'nigiri' ),
			)
		);
		
		$first_level_row4 = nigiri_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'nigiri' ),
			)
		);
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'nigiri' ),
			)
		);
		
		$first_level_row5 = nigiri_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = nigiri_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = nigiri_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'nigiri' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'nigiri' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = nigiri_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'nigiri' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'nigiri' )
			)
		);
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'nigiri' )
			)
		);
		...
		$second_level_wide_group = nigiri_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'nigiri' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'nigiri' )
			)
		);
		
		$second_level_wide_row1 = nigiri_elated_add_admin_row(
			array(
		...
		$second_level_wide_row2 = nigiri_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = nigiri_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = nigiri_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'nigiri' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'nigiri' )
			)
		);
		...
		$third_level_wide_group = nigiri_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'nigiri' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'nigiri' )
			)
		);
		
		$third_level_wide_row1 = nigiri_elated_add_admin_row(
			array(
		...
		$third_level_wide_row2 = nigiri_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = nigiri_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'nigiri_elated_action_header_main_navigation_options_map', 'nigiri_elated_header_main_navigation_options_map', 10, 1 );
}