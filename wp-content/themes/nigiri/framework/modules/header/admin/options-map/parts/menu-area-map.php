...
if ( ! function_exists( 'nigiri_elated_get_hide_dep_for_header_menu_area_options' ) ) {
	function nigiri_elated_get_hide_dep_for_header_menu_area_options() {
		$hide_dep_options = apply_filters( 'nigiri_elated_filter_header_menu_area_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'nigiri_elated_header_menu_area_options_map' ) ) {
	function nigiri_elated_header_menu_area_options_map( $panel_header ) {
		$hide_dep_options = nigiri_elated_get_hide_dep_for_header_menu_area_options();
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set grid background transparency for menu area', 'nigiri' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on grid area', 'nigiri' )
			)
		);
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set border color for menu area', 'nigiri' ),
			)
		);
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background color for menu area', 'nigiri' )
			)
		);
		...
		nigiri_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background transparency for menu area', 'nigiri' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		$menu_area_border_container = nigiri_elated_add_admin_container(
			array(
				'parent'          => $menu_area_container,
		...
		do_action( 'nigiri_elated_header_menu_area_additional_options', $panel_header );
	}
	
	add_action( 'nigiri_elated_action_header_menu_area_options_map', 'nigiri_elated_header_menu_area_options_map', 10, 1 );
}