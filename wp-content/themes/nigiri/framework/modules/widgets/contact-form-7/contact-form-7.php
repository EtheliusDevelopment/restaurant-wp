...
class NigiriElatedClassContactForm7Widget extends NigiriElatedClassWidget {
	public function __construct() {
		parent::__construct(
			'eltdf_contact_form_7_widget',
			esc_html__( 'Nigiri Contact Form 7 Widget', 'nigiri' ),
			array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'nigiri' ) )
		);
	...
	protected function setParams() {
		...
		$this->params = array(
			array(
				'type'  => 'textfield',
				'name'  => 'extra_class',
				'title' => esc_html__( 'Extra Class Name', 'nigiri' )
			),
			array(
				'type'  => 'textfield',
			...
			array(
				'type'    => 'dropdown',
				'name'    => 'contact_form',
				'title'   => esc_html__( 'Select Contact Form 7', 'nigiri' ),
				'options' => $contact_forms
			),
			array(
				'type'    => 'dropdown',
				'name'    => 'contact_form_style',
				'title'   => esc_html__( 'Contact Form 7 Style', 'nigiri' ),
				'options' => array(
	...
	public function widget( $args, $instance ) {
		...
		?>
		<div class="widget eltdf-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo nigiri_elated_get_inline_style( $widget_styles ); ?>>
