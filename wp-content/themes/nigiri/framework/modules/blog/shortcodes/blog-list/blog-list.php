<?php
namespace NigiriCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'nigiri' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'nigiri' ),
						'description' => esc_html__( 'Number of words', 'nigiri' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'nigiri' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'nigiri' ),
						'value'      => array_flip( nigiri_elated_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'nigiri' )
					),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Tags', 'nigiri' ),
						'value'      => array_flip( nigiri_elated_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'nigiri' )
					),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'nigiri' ),
						'value'      => array_flip( nigiri_elated_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'nigiri' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'nigiri' ),
						'value'      => array_flip( nigiri_elated_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'nigiri' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'nigiri' ),
						'value'      => array(
							esc_html__( 'None', 'nigiri' )            => 'no-pagination',
							esc_html__( 'Standard', 'nigiri' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'nigiri' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'nigiri' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'nigiri' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		nigiri_elated_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
