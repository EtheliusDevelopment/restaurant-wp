...
$blog_list_image_id  = ! empty( $image_meta ) && nigiri_elated_blog_item_has_link() ? nigiri_elated_get_attachment_id_from_url( $image_meta ) : '';
?>

<?php if ( $has_featured ) { ?>
	<div class="eltdf-post-image">
		<?php if ( nigiri_elated_blog_item_has_link() ) { ?>
		...
		<?php } ?>
		<?php do_action('nigiri_elated_action_blog_inside_image_tag')?>
	</div>
<?php } ?>