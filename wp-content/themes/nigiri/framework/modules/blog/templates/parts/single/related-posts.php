<?php
$show_related = nigiri_elated_options()->getOptionValue('blog_single_related_posts') == 'yes' ? true : false;
$related_post_number = nigiri_elated_sidebar_layout() === 'no-sidebar' ? 4 : 3;
$related_posts_options = array(
    'posts_per_page' => $related_post_number
);
$related_posts = nigiri_elated_get_blog_related_post_type(get_the_ID(), $related_posts_options);
        ...
        <div class="eltdf-related-posts-holder-inner">
            <?php if ( $related_posts && $related_posts->have_posts() ) : ?>
                <div class="eltdf-related-posts-title">
                    <h4><?php esc_html_e('Related Posts', 'nigiri' ); ?></h4>
                </div>
