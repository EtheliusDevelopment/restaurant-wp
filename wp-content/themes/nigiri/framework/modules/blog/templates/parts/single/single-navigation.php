<?php
$blog_single_navigation = nigiri_elated_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = nigiri_elated_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
		...
		<div class="eltdf-blog-single-navigation-inner clearfix">
			<?php
				...
				$post_navigation = array(
					'prev' => array(
						'label' => '<span class="eltdf-blog-single-nav-label">'.esc_html__('previous', 'nigiri').'</span>'
					),
					'next' => array(
						'label' => '<span class="eltdf-blog-single-nav-label">'.esc_html__('next', 'nigiri').'</span>'
					)
				);
