...
namespace NigiriCore\CPT\Shortcodes\ProductList;
...
class ProductList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List', 'nigiri' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Masonry', 'nigiri' )  => 'masonry'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Product Info Position', 'nigiri' ),
							'value'       => array(
								esc_html__( 'Info On Image Hover', 'nigiri' ) => 'info-on-image',
								esc_html__( 'Info Below Image', 'nigiri' )    => 'info-below-image'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Columns', 'nigiri' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Skin', 'nigiri' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Text Alignment', 'nigiri' ),
							'value'      => array(
								esc_html__( 'Default', 'nigiri' ) => '',
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Bottom Margin (px)', 'nigiri' ),
							'dependency' => array( 'element' => 'info_position', 'value'   => array( 'info-below-image' ) ),
							'group'      => esc_html__( 'Product Info Style', 'nigiri' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = nigiri_elated_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list', $params['type'], $params, $additional_params );
	...
	public function getTextWrapperStyles( $params ) {
		...
		if ( $params['info_bottom_margin'] !== '' ) {
			$styles[] = 'margin-bottom: ' . nigiri_elated_filter_px( $params['info_bottom_margin'] ) . 'px';
		}
