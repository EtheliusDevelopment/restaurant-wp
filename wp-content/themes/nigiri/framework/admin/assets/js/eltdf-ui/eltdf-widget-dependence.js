(function($) {
	...
	$(window).load(function() {
		...
		eltdfSocialIconsGroupWidgetFieldDependency();
	});
	...
	function eltdfSocialIconWidgetFieldDependency() {
		...
		var IconText = {
			'icon': ['icon_pack','fa_icon','fe_icon','ion_icon','simple_line_icon', 'icon_title' ],
			'text': 'social_text'
		};
	...
	/**
	 * Render field dependency for socialIcons group widget
	 */
	function eltdfSocialIconsGroupWidgetFieldDependency() {

		var layout = {
			'outline': ['border_color','hover_border_color' ]
		};

		eltdfUpdateWidgetSelection('eltdf_social_icons_group_widget', 'layout', layout);
	}
