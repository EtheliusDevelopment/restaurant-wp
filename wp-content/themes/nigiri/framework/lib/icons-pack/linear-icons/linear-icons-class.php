...
if ( ! function_exists( 'nigiri_elated_add_linear_icon_pack' ) ) {
	function nigiri_elated_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new NigiriElatedClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_collection', 'nigiri_elated_add_linear_icon_pack' );
}

if ( ! function_exists( 'nigiri_elated_add_linear_icon_pack_option' ) ) {
	function nigiri_elated_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'nigiri' );
		
		return $options;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_options', 'nigiri_elated_add_linear_icon_pack_option' );
}

class NigiriElatedClassLinearIcons implements iNigiriElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
