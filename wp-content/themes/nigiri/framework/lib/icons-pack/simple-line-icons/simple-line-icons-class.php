...
if ( ! function_exists( 'nigiri_elated_add_simple_line_icon_pack' ) ) {
	function nigiri_elated_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new NigiriElatedClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_collection', 'nigiri_elated_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'nigiri_elated_add_simple_line_icon_pack_option' ) ) {
	function nigiri_elated_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'nigiri' );
		
		return $options;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_options', 'nigiri_elated_add_simple_line_icon_pack_option' );
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_social_options', 'nigiri_elated_add_simple_line_icon_pack_option' );
}

class NigiriElatedClassSimpleLineIcons implements iNigiriElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'nigiri'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'nigiri'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'nigiri'),
            'icon-social-facebook'    => esc_html__('Facebook', 'nigiri'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'nigiri'),
            'icon-social-github'      => esc_html__('Github', 'nigiri'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'nigiri'),
            'icon-social-instagram'   => esc_html__('Instagram', 'nigiri'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'nigiri'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'nigiri'),
            'icon-social-reddit'      => esc_html__('Reddit', 'nigiri'),
            'icon-social-skype'       => esc_html__('Skype', 'nigiri'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'nigiri'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'nigiri'),
            'icon-social-spotify'     => esc_html__('Spotify', 'nigiri'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'nigiri'),
            'icon-social-twitter'     => esc_html__('Twitter', 'nigiri'),
            'icon-social-youtube'     => esc_html__('Youtube', 'nigiri')
        );
    }
