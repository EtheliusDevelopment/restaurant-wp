...
if ( ! function_exists( 'nigiri_elated_add_font_elegant_icon_pack' ) ) {
	function nigiri_elated_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new NigiriElatedClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_collection', 'nigiri_elated_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'nigiri_elated_add_font_elegant_icon_pack_option' ) ) {
	function nigiri_elated_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'nigiri' );
		
		return $options;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_options', 'nigiri_elated_add_font_elegant_icon_pack_option' );
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_social_options', 'nigiri_elated_add_font_elegant_icon_pack_option' );
}

class NigiriElatedClassIconsFontElegant implements iNigiriElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
