...
if ( ! function_exists( 'nigiri_elated_add_ion_icon_pack' ) ) {
	function nigiri_elated_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new NigiriElatedClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_collection', 'nigiri_elated_add_ion_icon_pack' );
}

if ( ! function_exists( 'nigiri_elated_add_ion_icon_pack_option' ) ) {
	function nigiri_elated_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'nigiri' );
		
		return $options;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_options', 'nigiri_elated_add_ion_icon_pack_option' );
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_social_options', 'nigiri_elated_add_ion_icon_pack_option' );
}

class NigiriElatedClassIonIcons implements iNigiriElatedInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
