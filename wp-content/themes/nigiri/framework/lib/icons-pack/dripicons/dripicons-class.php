...
if ( ! function_exists( 'nigiri_elated_add_dripicons_icon_pack' ) ) {
	function nigiri_elated_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new NigiriElatedClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_collection', 'nigiri_elated_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'nigiri_elated_add_dripicons_icon_pack_option' ) ) {
	function nigiri_elated_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'nigiri' );
		
		return $options;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_options', 'nigiri_elated_add_dripicons_icon_pack_option' );
}

class NigiriElatedClassDripicons implements iNigiriElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
