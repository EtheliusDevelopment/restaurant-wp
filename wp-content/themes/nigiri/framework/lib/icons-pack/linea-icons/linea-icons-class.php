...
if ( ! function_exists( 'nigiri_elated_add_linea_icon_pack' ) ) {
	function nigiri_elated_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new NigiriElatedClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_collection', 'nigiri_elated_add_linea_icon_pack' );
}

if ( ! function_exists( 'nigiri_elated_add_linea_icon_pack_option' ) ) {
	function nigiri_elated_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'nigiri' );
		
		return $options;
	}
	
	add_filter( 'nigiri_elated_filter_add_icon_pack_into_options', 'nigiri_elated_add_linea_icon_pack_option' );
}

class NigiriElatedClassLineaIcons implements iNigiriElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
